...
namespace TeamService.WEB.Filters
{
    public class ErrorFilter : Attribute, IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext filterContext)
        {
            ...
            if (!filterContext.ExceptionHandled)
            {
                ...
                var communicationServiceException = exception as ServiceCommunicationException;
                ...
                else if (communicationServiceException != null)
                {
                    filterContext.Result = new NotFoundObjectResult(new JsonResult(communicationServiceException.Message)
                    {
